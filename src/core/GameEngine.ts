...
export class GameEngine {
  private currentPhase: GamePhase = GamePhase.INIT;
  private players: (Bot | Player)[] = [];
  private player: Player;
  private difficulty: Difficulty = Difficulty.MEDIUM;
  private dayNumber = 0;
  private nightNumber = 0;
  private deadThisNight: string[] = [];
  private executedThisDay?: string;
   ...
   */
  private initializeTrustMaps(): void {
   ...
   */
  private handleDayDiscussionStart(): void {
   ...
   */
  private handleExecutionPhase(): void {
   ...
   */
  private countVotes(): [string, number][] {
   ...
   */
  private determineVoteTarget(bot: Bot): string {
