...
export class VotingSystem {
     ...
     */
    static calculateBotVote(voter, possibleTargets, currentVoteTally) {
     ...
     */
    static selectTargetByTrust(voter, targets, currentVoteTally) {
     ...
     */
    static updateTrustAfterVote(voters, votedFor, executed) {
        for (const voter of voters) {
            if (!(voter instanceof Bot))
                continue;
